...
import androidx.appcompat.app.AppCompatActivity //seems android libraries updated after book publishing to supercede v7 appcompat
...
class MainActivity : AppCompatActivity() {
    ...
    private fun resetGame() {
        ...
        val initialTimeLeft = getString(R.string.time_left, 10000)
